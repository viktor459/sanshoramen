...
const S = `
  ...
  *, *::before, *::after { box-sizing:border-box; margin:0; padding:0; }
  ...
  .field input { width:100%; padding:12px 16px; border:1.5px solid #DDD8CE; border-radius:10px; font-family:'Quicksand',sans-serif; font-size:14px; background:#FAFAF8; color:var(--ink); outline:none; transition:border-color 0.2s; }
...
export default function StalletBar2() {
